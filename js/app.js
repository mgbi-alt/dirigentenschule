...
function renderPruefungen(){
  ...
  const rows=cache.tt.filter(r=>r.pruefung||r.test);
  if(!rows.length){ el.innerHTML='<p class="muted" style="padding:14px">Keine Prüfungen oder Tests markiert.</p>'; return; }
